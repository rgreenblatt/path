...
endforeach()
string(APPEND __IMPLICT_LINKS " -lcudart -L/usr/local/cuda/lib64")
...
# NOTE: setting CMAKE_CUDA_HOST_FLAGS can't be done for this, it confuses the
# link phases below (just change __CU_FLAGS to CMAKE_CUDA_HOST_FLAGS in the
# set calls here to see...).
get_filename_component(_CMAKE_CUDA_COMPILER_NAME ${CMAKE_CUDA_COMPILER} NAME)
if (_CMAKE_CUDA_COMPILER_NAME MATCHES nvcc)
  set(__CU_FLAGS "-x cu")
elseif (_CMAKE_CUDA_COMPILER_NAME MATCHES clang)
  set(__CU_FLAGS "-x cuda")
  # PROBLEM: stuff between "" gets removed somewhere, that's why setting manual
  # /usr/local/cuda here...
  set(__CU_FLAGS "${__CU_FLAGS} --cuda-path=/usr/local/cuda")
  # TODO: select cuda compute arch would go here (?).  Clang detects valid /
...
# TODO: this needs to get unset at some point
# unset(_CMAKE_CUDA_COMPILER_NAME)
...
if(NOT CMAKE_CUDA_COMPILE_PTX_COMPILATION)
  set(CMAKE_CUDA_COMPILE_PTX_COMPILATION
    "<CMAKE_CUDA_COMPILER> ${CMAKE_CUDA_HOST_FLAGS} <DEFINES> <INCLUDES> <FLAGS> ${__CU_FLAGS} -ptx <SOURCE> -o <OBJECT>")
endif()
...
if(NOT CMAKE_CUDA_COMPILE_SEPARABLE_COMPILATION)
  set(CMAKE_CUDA_COMPILE_SEPARABLE_COMPILATION
    "<CMAKE_CUDA_COMPILER> ${CMAKE_CUDA_HOST_FLAGS} <DEFINES> <INCLUDES> <FLAGS> ${__CU_FLAGS} -dc <SOURCE> -o <OBJECT>")
endif()

#Specify how to compile when whole compilation has been requested
if(NOT CMAKE_CUDA_COMPILE_WHOLE_COMPILATION)
  set(CMAKE_CUDA_COMPILE_WHOLE_COMPILATION
    "<CMAKE_CUDA_COMPILER> ${CMAKE_CUDA_HOST_FLAGS} <DEFINES> <INCLUDES> <FLAGS> ${__CU_FLAGS} -c <SOURCE> -o <OBJECT>")
endif()

if(CMAKE_GENERATOR STREQUAL "Ninja")
  set(CMAKE_CUDA_COMPILE_DEPENDENCY_DETECTION
    "<CMAKE_CUDA_COMPILER> ${CMAKE_CUDA_HOST_FLAGS} <DEFINES> <INCLUDES> <FLAGS> ${__CU_FLAGS} -M <SOURCE> -MT <OBJECT> -o $DEP_FILE")
...
if(NOT CMAKE_CUDA_LINK_EXECUTABLE)
  set(CMAKE_CUDA_LINK_EXECUTABLE
    "<CMAKE_CUDA_COMPILER> <LINK_FLAGS> <OBJECTS> -o <TARGET> <LINK_LIBRARIES> ${__IMPLICT_LINKS}")
endif()
...
set(_CMAKE_CUDA_EXTRA_DEVICE_LINK_FLAGS "${_CMAKE_CUDA_EXTRA_DEVICE_LINK_FLAGS} -dlink")
#These are used when linking relocatable (dc) cuda code
if(NOT CMAKE_CUDA_DEVICE_LINK_LIBRARY)
  set(CMAKE_CUDA_DEVICE_LINK_LIBRARY
      "/usr/local/cuda/bin/nvcc ${CMAKE_CUDA_HOST_FLAGS} <LANGUAGE_COMPILE_FLAGS> ${CMAKE_CUDA_COMPILE_OPTIONS_PIC} ${_CMAKE_CUDA_EXTRA_DEVICE_LINK_FLAGS} <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
endif()
if(NOT CMAKE_CUDA_DEVICE_LINK_EXECUTABLE)
  set(CMAKE_CUDA_DEVICE_LINK_EXECUTABLE
      "/usr/local/cuda/bin/nvcc ${CMAKE_CUDA_HOST_FLAGS} <FLAGS> ${CMAKE_CUDA_COMPILE_OPTIONS_PIC} ${_CMAKE_CUDA_EXTRA_DEVICE_LINK_FLAGS} <OBJECTS> -o <TARGET> <LINK_LIBRARIES>")
endif()
