...
__thrust_exec_check_disable__ template <
...
__host__ __device__ constexpr auto invoke(Fn &&f, Args &&... args) noexcept(
...
struct optional_storage_base {
  ...
  __thrust_exec_check_disable__ template <class... U>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR
  optional_storage_base(in_place_t, U &&... u)
      : m_value(std::forward<U>(u)...), m_has_value(true) {}

  __thrust_exec_check_disable__ __host__ __device__ ~optional_storage_base() {
    if (m_has_value) {
      m_value.~T();
      m_has_value = false;
    }
...
template <class T> struct optional_operations_base : optional_storage_base<T> {
  ...
  __thrust_exec_check_disable__ __host__ __device__ void hard_reset() noexcept {
    get().~T();
  ...
  __thrust_exec_check_disable__ template <class Opt>
  __host__ __device__ void assign(Opt &&rhs) {
    if (this->has_value()) {
      if (rhs.has_value()) {
  ...
  __thrust_exec_check_disable__ __host__ __device__ bool has_value() const {
    return this->m_has_value;
  }

  __thrust_exec_check_disable__
      __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR T &
      get() & {
    return this->m_value;
  }
  __thrust_exec_check_disable__
      __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR const T &
      get() const & {
    return this->m_value;
  }
  __thrust_exec_check_disable__
...
struct optional_copy_base<T, false> : optional_operations_base<T> {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_copy_base() =
      default;
...
template <class T> struct optional_move_base<T, false> : optional_copy_base<T> {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_move_base() =
      default;
  __thrust_exec_check_disable__ __host__ __device__
...
struct optional_copy_assign_base<T, false> : optional_move_base<T> {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_copy_assign_base &
...
struct optional_move_assign_base<T, false> : optional_copy_assign_base<T> {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_move_assign_base &
...
struct optional_delete_ctor_base {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_delete_ctor_base &
...
struct optional_delete_assign_base {
  ...
  __thrust_exec_check_disable__ __host__ __device__ optional_delete_assign_base(
      optional_delete_assign_base &&) noexcept = default;
  __thrust_exec_check_disable__
      __host__ __device__ optional_delete_assign_base &
...
struct nullopt_t {
  struct do_not_use {};
  __host__ __device__ constexpr explicit nullopt_t(do_not_use,
                                                   do_not_use) noexcept {}
};
...
public:
  ...
  __host__ const char *what() const noexcept { return "Optional has no value"; }
};
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR auto and_then(F &&f) & {
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr auto and_then(F &&f) const & {
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__
      __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR detail::invoke_result_t<F, T &>
      and_then(F &&f) & {
    using result = detail::invoke_result_t<F, T &>;
    static_assert(detail::is_optional<result>::value,
                  "F must return an optional");
  ...
  /// \synopsis template <class F>\nconstexpr auto and_then(F &&f) const &;
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr detail::invoke_result_t<F, const T &>
  and_then(F &&f) const & {
    using result = detail::invoke_result_t<F, const T &>;
    static_assert(detail::is_optional<result>::value,
                  "F must return an optional");
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR auto map(F &&f) & {
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr auto map(F &&f) const & {
    return optional_map_impl(*this, std::forward<F>(f));
  }
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR decltype(
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr decltype(
  ...
  /// \synopsis template <class F> auto map(F &&f) const&&;
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr decltype(optional_map_impl(
  ...
  __thrust_exec_check_disable__ template <
      class F, detail::enable_if_ret_void<F> * = nullptr>
  __host__ __device__ optional<T>
  ...
  /// \exclude
  __thrust_exec_check_disable__ template <
      class F, detail::disable_if_ret_void<F> * = nullptr>
  __host__ __device__ optional<T>
      THRUST_OPTIONAL_CPP11_CONSTEXPR or_else(F &&f) & {
  ...
  __thrust_exec_check_disable__ template <
      class F, detail::enable_if_ret_void<F> * = nullptr>
  __host__ __device__ optional<T> or_else(F &&f) && {
    if (has_value())
  ...
  __thrust_exec_check_disable__ template <
      class F, detail::enable_if_ret_void<F> * = nullptr>
  __host__ __device__ optional<T> or_else(F &&f) const & {
    if (has_value())
      return *this;
  ...
  __thrust_exec_check_disable__ template <
      class F, detail::disable_if_ret_void<F> * = nullptr>
  __host__ __device__ optional<T>
      THRUST_OPTIONAL_CPP11_CONSTEXPR or_else(F &&f) const & {
    return has_value() ? *this : std::forward<F>(f)();
  }
  ...
  ///
  /// \group map_or
  __thrust_exec_check_disable__ template <class F, class U>
  __host__ __device__ U map_or(F &&f, U &&u) & {
    return has_value() ? detail::invoke(std::forward<F>(f), **this)
                       : std::forward<U>(u);
  }
  ...
  /// \group map_or
  __thrust_exec_check_disable__ template <class F, class U>
  __host__ __device__ U map_or(F &&f, U &&u) const & {
    return has_value() ? detail::invoke(std::forward<F>(f), **this)
                       : std::forward<U>(u);
  }
  ...
  __thrust_exec_check_disable__ template <class F, class U>
  __host__ __device__ detail::invoke_result_t<U> map_or_else(F &&f, U &&u) & {
    return has_value() ? detail::invoke(std::forward<F>(f), **this)
                       : std::forward<U>(u)();
  }
  ...
  /// const &;
  __thrust_exec_check_disable__ template <class F, class U>
  __host__ __device__ detail::invoke_result_t<U> map_or_else(F &&f,
                                                             U &&u) const & {
    return has_value() ? detail::invoke(std::forward<F>(f), **this)
                       : std::forward<U>(u)();
  }
  ...
  __thrust_exec_check_disable__ template <class U>
  __host__ __device__ constexpr optional<typename std::decay<U>::type>
  ...
  /// \group disjunction
  __thrust_exec_check_disable__
      __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR optional
      disjunction(const optional &rhs) & {
    return has_value() ? *this : rhs;
  }

  /// \group disjunction
  __thrust_exec_check_disable__ __host__ __device__ constexpr optional
  ...
  /// \group take
  __thrust_exec_check_disable__ __host__ __device__ optional take() & {
    optional ret = *this;
    reset();
    return ret;
  }
  ...
  /// \group take
  __thrust_exec_check_disable__ __host__ __device__ optional take() const & {
    optional ret = *this;
    reset();
    return ret;
  }
  ...
  /// \group ctor_empty
  __thrust_exec_check_disable__ constexpr optional() noexcept = default;

  /// \group ctor_empty
  __thrust_exec_check_disable__
      __host__ __device__ constexpr optional(nullopt_t) noexcept {}

  /// Copy constructor
  ///
  /// If `rhs` contains a value, the stored value is direct-initialized with
  /// it. Otherwise, the constructed optional is empty.
  __thrust_exec_check_disable__ THRUST_OPTIONAL_CPP11_CONSTEXPR
  ...
  /// Args&&... args);
  __thrust_exec_check_disable__ template <class... Args>
  __host__ __device__ constexpr explicit optional(
  ...
  __thrust_exec_check_disable__ template <class U, class... Args>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR explicit optional(
  ...
  __host__ __device__ constexpr optional(U &&u)
  ...
  __thrust_exec_check_disable__ template <
      ...
      detail::enable_if_t<!std::is_convertible<U &&, T>::value> * = nullptr,
      detail::enable_forward_value<T, U> * = nullptr>
  __host__ __device__ constexpr explicit optional(U &&u)
      : base(in_place, std::forward<U>(u)) {}
  ...
  __host__ __device__ optional(const optional<U> &rhs) {
    this->construct(*rhs);
  }
  ...
  __thrust_exec_check_disable__ template <
      ...
      detail::enable_if_t<!std::is_convertible<const U &, T>::value> * =
          nullptr>
  __host__ __device__ explicit optional(const optional<U> &rhs) {
    this->construct(*rhs);
  }
  ...
  __thrust_exec_check_disable__ template <
      ...
      detail::enable_if_t<std::is_convertible<U &&, T>::value> * = nullptr>
  __host__ __device__ optional(optional<U> &&rhs) {
  ...
  __thrust_exec_check_disable__ template <
      class U, detail::enable_from_other<T, U, U &&> * = nullptr,
      detail::enable_if_t<!std::is_convertible<U &&, T>::value> * = nullptr>
  __host__ __device__ explicit optional(optional<U> &&rhs) {
    this->construct(std::move(*rhs));
  }

  /// Destroys the stored value if there is one.
  __thrust_exec_check_disable__ ~optional() = default;

  /// Assignment to empty.
  ///
  /// Destroys the current value if there is one.
  __thrust_exec_check_disable__ __host__ __device__ optional &
  ...
  /// value in `*this`.
  __thrust_exec_check_disable__ optional &
  ...
  /// value in `*this`.
  __thrust_exec_check_disable__ optional &operator=(optional &&rhs) = default;

  /// Assigns the stored value from `u`, destroying the old value if there was
  /// one.
  /// \synopsis optional &operator=(U &&u);
  __thrust_exec_check_disable__ template <
      class U = T, detail::enable_assign_forward<T, U> * = nullptr>
  __host__ __device__ optional &operator=(U &&u) {
    if (has_value()) {
  ...
  __thrust_exec_check_disable__ template <
      class U, detail::enable_assign_from_other<T, U, const U &> * = nullptr>
  __host__ __device__ optional &operator=(const optional<U> &rhs) {
    if (has_value()) {
      if (rhs.has_value()) {
        this->m_value = *rhs;
      } else {
  ...
  __thrust_exec_check_disable__ template <
      class U, detail::enable_assign_from_other<T, U, U> * = nullptr>
  __host__ __device__ optional &operator=(optional<U> &&rhs) {
    if (has_value()) {
      if (rhs.has_value()) {
  ...
  __thrust_exec_check_disable__ template <class U, class... Args>
  __host__ __device__ detail::enable_if_t<
  ...
  /// \group has_value
  __thrust_exec_check_disable__ __host__ __device__ constexpr explicit
  ...
  __host__ THRUST_OPTIONAL_CPP11_CONSTEXPR T &value() & {
    if (has_value())
      return this->m_value;
  ...
  __host__ THRUST_OPTIONAL_CPP11_CONSTEXPR const T &value() const & {
    if (has_value())
      return this->m_value;
    throw bad_optional_access();
  }
  ...
  /// \group value_or
  __thrust_exec_check_disable__ template <class U>
  __host__ __device__ constexpr T value_or(U &&u) const & {
  ...
  /// \group value_or
  __thrust_exec_check_disable__ template <class U>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR T value_or(U &&u) && {
  ...
  __thrust_exec_check_disable__ __host__ __device__ void reset() noexcept {
    if (has_value()) {
      this->m_value.~T();
      this->m_has_value = false;
    }
...
/// is not.
__thrust_exec_check_disable__ template <class T, class U>
__host__ __device__ inline constexpr bool operator==(const optional<T> &lhs,
...
__thrust_exec_check_disable__ template <class T>
__host__ __device__ inline constexpr bool operator==(const optional<T> &lhs,
                                                     nullopt_t) noexcept {
...
/// \group relop_nullopt
__thrust_exec_check_disable__ template <class T>
__host__ __device__ inline constexpr bool
...
/// \group relop_nullopt
__thrust_exec_check_disable__ template <class T>
__host__ __device__ inline constexpr bool operator<(const optional<T> &,
                                                    nullopt_t) noexcept {
  return false;
}
/// \group relop_nullopt
...
/// \group relop_t
__thrust_exec_check_disable__ template <class T, class U>
__host__ __device__ inline constexpr bool operator==(const U &lhs,
...
__host__ __device__ inline constexpr optional<Ret> make_optional(U &&v) {
  return optional<Ret>(std::forward<U>(v));
}

__thrust_exec_check_disable__ template <class T, class... Args>
__host__ __device__ inline constexpr optional<T>
make_optional(Args &&... args) {
  return optional<T>(in_place, std::forward<Args>(args)...);
}
__thrust_exec_check_disable__ template <class T, class U, class... Args>
__host__ __device__ inline constexpr optional<T>
...
__host__ __device__ constexpr auto optional_map_impl(Opt &&opt, F &&f) {
...
__thrust_exec_check_disable__ template <
    ...
    class Ret = decltype(detail::invoke(std::declval<F>(),
                                        *std::declval<Opt>())),
    detail::enable_if_t<std::is_void<Ret>::value> * = nullptr>
__host__ __device__ auto optional_map_impl(Opt &&opt, F &&f) {
  if (opt.has_value()) {
    detail::invoke(std::forward<F>(f), *std::forward<Opt>(opt));
...
// http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2017/p0826r0.html
  ...
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ THRUST_OPTIONAL_CPP11_CONSTEXPR decltype(
      detail::optional_map_impl(std::declval<optional &>(),
                                std::declval<F &&>()))
  map(F &&f) & {
    return detail::optional_map_impl(*this, std::forward<F>(f));
  }
  ...
  /// \synopsis template <class F> auto map(F &&f) const&;
  __thrust_exec_check_disable__ template <class F>
  __host__ __device__ constexpr decltype(detail::optional_map_impl(
      std::declval<const optional &>(), std::declval<F &&>()))
  map(F &&f) const & {
    return detail::optional_map_impl(*this, std::forward<F>(f));
  }
  ...
  /// \group ctor_empty
  __thrust_exec_check_disable__
      __host__ __device__ constexpr optional() noexcept
      : m_value(nullptr) {}
  ...
  __thrust_exec_check_disable__ template <
      ...
      detail::enable_if_t<!detail::is_optional<detail::decay_t<U>>::value> * =
          nullptr>
  __host__ __device__ constexpr optional(U &&u) : m_value(addressof(u)) {
    static_assert(std::is_lvalue_reference<U>::value, "U must be an lvalue");
  }

  /// \exclude
  __thrust_exec_check_disable__ template <class U>
  __host__ __device__ constexpr explicit optional(const optional<U> &rhs)
      : optional(*rhs) {}
  ...
  /// \group emplace
  __thrust_exec_check_disable__ template <class... Args>
  __host__ __device__ T &emplace(Args &&... args) noexcept {
    static_assert(std::is_constructible<T, Args &&...>::value,
                  "T must be constructible with Args");
  ...
  /// \group deref
  /// \synopsis constexpr T &operator*();
  __thrust_exec_check_disable__ THRUST_OPTIONAL_CPP11_CONSTEXPR T &operator*() {
    return *m_value;
  }
  ...
  /// Destroys the stored value if one exists, making the optional empty
  __thrust_exec_check_disable__ void reset() noexcept { m_value = nullptr; }
...
template <class T> struct hash<thrust::optional<T>> {
  __thrust_exec_check_disable__ __host__ __device__ ::std::size_t
  operator()(const thrust::optional<T> &o) const {
    if (!o.has_value())
      return 0;
