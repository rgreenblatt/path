...
TraversalGrid::TraversalGrid(const TriangleProjector &projector,
                             ...
                             unsigned start_shape_grids, bool flip_x,
                             bool flip_y)
    : projector_(projector), min_(min), max_(max), min_indexes_(0, 0),
      ...
      start_shape_grids_(start_shape_grids), flip_x_(flip_x), flip_y_(flip_y) {}
...
void TraversalGrid::wipeShape(unsigned shape_to_wipe,
  ...
  shape_grids[shape_to_wipe + start_shape_grids_] =
      ShapePossibles{num_divisions_x_, 0, num_divisions_y_, 0};
}
