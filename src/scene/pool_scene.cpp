...
PoolScene::PoolScene() {
  shapes_.push_back(ShapeData(
      ...
      Material(Color(0, 1, 0), Color(0.5, 0, 0), Color::Zero(), Color::Zero(),
               Color::Zero(), Color::Zero(), thrust::nullopt, 0, 0, 0)));
  shapes_.push_back(ShapeData(
      static_cast<Transform>(Eigen::Translation3f(-3, 2, 1)),
      Material(Color(0, 0, 1), Color::Zero(), Color(0.3, 0.3, 0.3), Color::Zero(),
               Color::Zero(), Color::Zero(), thrust::nullopt, 0, 7, 0)));
  shapes_.push_back(ShapeData(
      ...
      Material(Color(0, 0, 1), Color::Zero(), Color::Zero(), Color(0.7, 0, 0),
               Color::Zero(), Color::Zero(), thrust::nullopt, 0, 10, 0)));
  shapes_.push_back(ShapeData(
