...
struct WorkDivisionSettings {
  ...
  SETTING_BODY(WorkDivisionSettings, block_size, target_x_block_size,
               force_target_samples, forced_target_samples_per_thread,
               base_num_threads, samples_per_thread_scaling_power,
