...
public:
  ...
  bool getGlobalData(CS123SceneGlobalData &data) const override;

  bool getCameraData(CS123SceneCameraData &data) const override;

  CS123SceneNode *getRootNode() const override;

  int getNumLights() const override;

  // Returns the ith light data
  bool getLightData(int i, CS123SceneLightData &data) const override;
