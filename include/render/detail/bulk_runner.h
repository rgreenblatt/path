...
namespace render {
namespace detail {
template <ExecutionModel exec, unsigned n_light_samples, rng::RngState R>
class BulkRunner {
public:
  BulkRunner() {}
  ...
  void run_bulk(const work_division::WorkDivision &division,
                const GeneralSettings &settings, I &intersector,
...
private:
  ExecVector<exec, integrate::RenderingEquationState<n_light_samples>> state_;
